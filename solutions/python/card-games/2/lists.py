...
def get_rounds(number):
    ...
    """
    current_round_and_2 = [number, number + 1, number +2]
    return current_round_and_2
...
def approx_average_is_average(hand):
    ...
    average2 = hand[middle_index]
    return average in (average1, average2)
